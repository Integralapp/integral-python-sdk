...
class ApplicationUser(pydantic.BaseModel):
    id: str
    ...
    application_user_foreign_id: str = pydantic.Field(alias="applicationUserForeignId")
    metadata: typing.Optional[typing.Dict[str, typing.Any]]
    application_role: ApplicationRole = pydantic.Field(alias="applicationRole")
